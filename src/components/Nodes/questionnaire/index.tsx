...
const Questionnaire = ({ xPos, yPos, id }: NodeTypeT) => {
  return (
    <NodeBaseLayout
      nodeId={id}
      xPos={xPos}
      yPos={yPos}
      type={NODE_TYPES.QUESTIONNAIRE}
    >
      <DefaultNode nodeId={id} type={NODE_TYPES.QUESTIONNAIRE}>
        <div className="node-header">Questionnaire</div>
      </DefaultNode>
    </NodeBaseLayout>
  );
};
