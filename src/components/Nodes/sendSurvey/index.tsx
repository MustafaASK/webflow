...
const SendSurvey = ({ xPos, yPos, id }: NodeTypeT) => {
  return (
    <NodeBaseLayout
      nodeId={id}
      xPos={xPos}
    ...
    >
      <DefaultNode nodeId={id} type={NODE_TYPES.SEND_FORM}>
        <div className="node-header">Send Form</div>
      </DefaultNode>
    </NodeBaseLayout>
  );
};

export default memo(SendSurvey);
